...
window.onload = function () {
  ...
  var config = {audio: true, video: true, data: true, screen: screen, maxFrameRate:60, videoSize: [640, 208, 640, 208]};
  ...
  createToken("user", "presenter", function (response) {
    ...
    localStream.addEventListener("access-accepted", function () {
      ...
      room.addEventListener("room-connected", function (roomEvent) {
        ...
        room.publish(localStream, {maxVideoBW: 1024, minVideoBW:100});
      ...
      room.addEventListener("stream-subscribed", function(streamEvent) {
        ...
        div.setAttribute("style", "width: 450px; height: 338px;");
